## Avoid duplication of code by creating reusable functions or components. When you notice similar code blocks, refactor them into a single function or component that can be called with different parameters. This improves maintainability and reduces the risk of bugs.--- description: This file provides instructions to avoid code duplication by creating reusable functions or components. applyTo: \*\*/*.*

Avoid duplication of code by creating reusable functions or components. When you notice similar code blocks, refactor them into a single function or component that can be called with different parameters. This improves maintainability and reduces the risk of bugs. For example, if you have multiple instances of similar logic for data processing, consider creating a function like this:
